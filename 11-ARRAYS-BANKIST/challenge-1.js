...
const checkDogs = function (dogsJulia, dogsKate) {
  ...
  const dogsJuliaCorr = dogsJulia.slice();  // array copy;
  dogsJuliaCorr.splice(0,1);                // remove 1st element
  dogsJuliaCorr.splice(-2);                 // remove last 2 elements
  // same
  // dogsJuliaCorr.slice(1,3);              // arr with 1st and 2nd elements
  // console.log('dogsJuliaCorr: ', dogsJuliaCorr);
